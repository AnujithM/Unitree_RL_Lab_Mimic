...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        # Generated from PHUMA retargeted motion via:
        #   python scripts/mimic/phuma_to_csv.py -f <phuma_npy> -o <output_dir>
        #   python scripts/mimic/csv_to_npz.py -f <output_csv> --input_fps 30
        motion_file=f"{os.path.dirname(__file__)}/D2_-_walk_to_ready_stageii_chunk_0000.npz",
